...
e.preventDefault();
    ...
    main();
    //Adds touch controls and arrow controls to move left or right the player.
    // var UP_KEY = 38;
    // var DOWN_KEY = 40;
    // var LEFT_KEY = 37;
    // var RIGHT_KEY = 39;
    ...
    // function simKeyLeft(e, keyCode)
    // {
    //     e.preventDefault();
    //     queueKeyboardEvent("KeyLeft", keyCode);
    // }
    // function simKeyRight(e, keyCode)
    // {
    //     e.preventDefault();
    //     queueKeyboardEvent("KeyRight", keyCode);
    // }
    // function queueKeyboardEvent(eventType, keyCode)
    // {
    //     if(eventType === 'KeyLeft')
    //     {
    //         if(keyCode == LEFT_KEY)
    //         {
    ...
    //         }
    //     }
    //     else if(eventType === 'KeyEnter')
    //     {
    //         if(keyCode == 13 && player.gameOver == true)
    //         {
    //             main();
    //             window.clearTimeout(timer);
    //         }
